...
JOBS = [
    ...
    ("B", "e2e",           "paperb_e2e.py",
     "small end-to-end fixture using one record list, anchor, beacon, proof and openings"),
    ("B", "e2e-durable",   "paperb_durable.py",
     "durable SQLite fixture: atomic close, restart, receipts, beacon, full proofs and fault tests"),
    ...
    ("A", "correctness",   "a_impl_audit.py",
     "LC-FPE round trip, encoding injectivity, field width, alias uniformity"),
